...
RDREC	LDX     ZERO    .CLEAR LOOP COUNTER
	LDA     ZERO    .CLAER A TO ZERO
RLOOP	TD      INPUT   .TEST INPUT DEVICE
	JEQ     RLOOP   .LOOP UNTIL READY
	RD      INPUT   .TEST INPUT DEVICE 
...
EXIT	STX     LENGTH
	RSUB
INPUT	BYTE    0       .CODE FOR INPUTDEVICE
MAXLEN	WORD    4096
...
WLOOP	TD      OUTPUT  .TEST OUTPUT DEVICE
	...
	TIX     LENGTH  .LOOP UNTIL ALL CHARACTERS HAVE BEEN WRITTEN
	JLT     WLOOP
	RSUB            .RETURN TO CALLER
OUTPUT	BYTE    1       .CODE FOR OUTPUTDEVICE
	END     COPY